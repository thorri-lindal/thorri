...
Frá Marxísku sjónarhorni er **Regina George** betur þekkt sem býflugnadrottning "The Plastics", holdgervingur kapítalískrar borgarastéttar (e. *Capitalist bourgeoisie*). Aðgerðir hennar enduróma kenningu Marx um umframvirði þar sem hún (asserts) yfirráð sín með því að nýta þá sem í kringum hana eru. Hún gerir þetta með ofurvaldi sínu (e. Hegemony), ekki með fjármagni (e. capital), heldur með félagslegu og táknrænu fjármagni t.a.m - vinsældum, yfirburðar fegurð, óaðfinnanlegt tískuskyn - sem hún dreifir á milli þegna sinna (e. subjects) á sínum eigin forsendum. 

Hin alræmda 'Brunabók' (Burn Book) hennar Reginu er því ekki bara hin týpíska orðrómsmylla menntaskóla, heldur tæki hugmyndafræðilegs ríkiskerfis, sem ritstýrir og skilgreinir orðræðuna og ádeilu og styrkir stjórn hennar á þjóðfélagsskipan (e. social order) menntaskólans.
...
### Innræting plastsins
Innleiðing (raunar innræting(?) (e. infiltration)) Cady í hóp hinna plastkenndu undir því yfirskyni að steypa Reginu George af stóli endurspeglar verkalýðsbyltingu / byltingu verkalýðsins (e. proletariat revolution). 
